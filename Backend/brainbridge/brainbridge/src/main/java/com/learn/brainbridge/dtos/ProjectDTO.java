...
public class ProjectDTO {
    ...
    public ProjectStatus getProject_status() { return projectStatus; }
    public void setProject_status(ProjectStatus project_status) { this.projectStatus = project_status; }

    public ProjectVisibility getProject_visibility() { return projectVisibility; }
    public void setProject_visibility(ProjectVisibility project_visibility) { this.projectVisibility = project_visibility; }
